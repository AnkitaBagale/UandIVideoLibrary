...
export const HomePage = ()=>{
    return(
    <>
        <AlertBar message={"Start your learning journey with us. "} classname={"alert-box alert-secondary text-center"} linkText={"Explore Videos"} linkto={"/explore"} />
        
        <div className="layout-container" style={{backgroundImage: `url(${bannerTop})`}}>
            
            <div className="text-overlay">
                <h2>Learn and Excel</h2>
                <p>If you love painting and thinking where to start, you are at the right place. Start your learning jorney with us</p>
                <div>
                    <Link to="/explore" className="btn btn-solid-primary">Explore Now</Link>
                </div>
            </div>
        </div>
